...
# --- Streamlit App ---
st.title("CodeBridge with Transformer 🎉")

st.write("Welcome to the CodeBridge! 🌟 Convert pseudocode to C++ or C++ to pseudocode using a Transformer model trained on the SPOC dataset. 🚀")
